...
3. 
Trois variantes du logo existent : **bordeaux** (par defaut), **vert foret** et **bleu nuit**. L'idee est de laisser chacun choisir la sienne dans les reglages de son compte.
...
3 membre bêta pour aider à la validation et surtout stabilisation de la plateforme
